...
//        }
//
//        // Get the full population of solutions
//        Population fullPopulation = algorithm.getPopulation();
//
//        // Display multiple game results
//        int gameNumber = 1;
//        for (Solution solution : fullPopulation) {
//            TicTacToeVariable variable = (TicTacToeVariable) solution.getVariable(0);
//
//            // Show the Tic-Tac-Toe board configuration
//            System.out.println("Game " + gameNumber + " Final Game Board:");
//            System.out.println(variable.toString());
//
//            // Show the objectives (game result and number of moves)
//            System.out.println("Objectives:");
